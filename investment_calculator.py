...
monthly = st.number_input("Monthly Investment ($)", value=200.0)  
increase = st.slider("Annual Increase in Monthly Investment (%)", 0.0, 20.0, 0.0)  
return_rate = st.slider("Expected Annual Return (%)", 0.0, 20.0, 7.0)  
